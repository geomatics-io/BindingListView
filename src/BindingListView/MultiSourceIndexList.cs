...
namespace Equin.ApplicationFramework
{
    ...
    {
        public void Add(IList sourceList, EditableObject<T> item, int index)
        {
        ...
        public EditableObject<T>[] Keys
        {
            get
            {
                return ConvertAll<EditableObject<T>>(new Converter<KeyValuePair<ListItemPair<T>, int>, EditableObject<T>>(
    ...
    {
        private IList _list;
        private EditableObject<T> _item;

        public ListItemPair(IList list, EditableObject<T> item)
        {
            _list = list;
            _item = item;
        }
